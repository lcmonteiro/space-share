...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libNetShareNative.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	/opt/android-arm64/bin/aarch64-linux-android-g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libNetShareNative.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -llog -D__LOG__ -shared -fPIC
