...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fileshare: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fileshare ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/a4d9402d/SCodec.o: ../../Share/Skernel/SCodecV1/SCodec.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a4d9402d
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/a4d9402d/SCodec.o ../../Share/Skernel/SCodecV1/SCodec.cpp

${OBJECTDIR}/_ext/a4d9402d/SCodecStamp.o: ../../Share/Skernel/SCodecV1/SCodecStamp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a4d9402d
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/a4d9402d/SCodecStamp.o ../../Share/Skernel/SCodecV1/SCodecStamp.cpp
...
${OBJECTDIR}/_ext/44f86887/SHash.o: ../../Space/Skernel/SHash.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/44f86887
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/44f86887/SHash.o ../../Space/Skernel/SHash.cpp
