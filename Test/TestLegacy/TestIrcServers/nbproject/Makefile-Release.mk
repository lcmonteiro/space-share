...
${OBJECTDIR}/_ext/44f86887/SAddress.o: ../../Space/Skernel/SAddress.cpp
	...
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/44f86887/SAddress.o ../../Space/Skernel/SAddress.cpp

${OBJECTDIR}/_ext/44f86887/SBase64.o: ../../Space/Skernel/SBase64.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/44f86887
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/44f86887/SBase64.o ../../Space/Skernel/SBase64.cpp

${OBJECTDIR}/_ext/44f86887/SContainer.o: ../../Space/Skernel/SContainer.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/44f86887
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/44f86887/SContainer.o ../../Space/Skernel/SContainer.cpp

${OBJECTDIR}/_ext/44f86887/SStream.o: ../../Space/Skernel/SStream.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/44f86887
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/44f86887/SStream.o ../../Space/Skernel/SStream.cpp

${OBJECTDIR}/_ext/44f86887/STask.o: ../../Space/Skernel/STask.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/44f86887
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/44f86887/STask.o ../../Space/Skernel/STask.cpp

${OBJECTDIR}/_ext/a7c70a66/SLinuxDir.o: ../../Space/Sstream/Slinux/SLinuxDir.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a7c70a66
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/a7c70a66/SLinuxDir.o ../../Space/Sstream/Slinux/SLinuxDir.cpp

${OBJECTDIR}/_ext/a7c70a66/SLinuxFile.o: ../../Space/Sstream/Slinux/SLinuxFile.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a7c70a66
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/a7c70a66/SLinuxFile.o ../../Space/Sstream/Slinux/SLinuxFile.cpp

${OBJECTDIR}/_ext/a7c70a66/SLinuxIRC.o: ../../Space/Sstream/Slinux/SLinuxIRC.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a7c70a66
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/a7c70a66/SLinuxIRC.o ../../Space/Sstream/Slinux/SLinuxIRC.cpp

${OBJECTDIR}/_ext/a7c70a66/SLinuxResource.o: ../../Space/Sstream/Slinux/SLinuxResource.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a7c70a66
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/a7c70a66/SLinuxResource.o ../../Space/Sstream/Slinux/SLinuxResource.cpp

${OBJECTDIR}/_ext/a7c70a66/SLinuxSocket.o: ../../Space/Sstream/Slinux/SLinuxSocket.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a7c70a66
	$(COMPILE.cc) -O2 -o ${OBJECTDIR}/_ext/a7c70a66/SLinuxSocket.o ../../Space/Sstream/Slinux/SLinuxSocket.cpp
