 ...
 * SetNoDelay
 */
SLocalResource& SLocalResource::SetNoDelay(bool flag) {
    int f = flag ? 1 : 0;
    if (::setsockopt(
...
Message::SLocalResource& Message::SLocalResource::Wait(
    const std::string& host, chrono::seconds timeout
) {
    uint16_t port=0;
 ...
 * link
 */
Message::SLocalResource& Message::SLocalResource::Link(const std::string& host) {
...
Stream::SLocalResource& Stream::SLocalResource::Wait(
    const string& host, chrono::seconds timeout
) {
    uint16_t port = 0;
    /**
     * bind parameters
 ...
 * ------------------------------------------------------------------------------------------------
 */
Stream::SLocalResource& Stream::SLocalResource::Link(const std::string& host) {
    uint16_t host_port = 0;
    /**
     * connect parameters
     */
